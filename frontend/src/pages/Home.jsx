    ...
    <div style={{ maxWidth: '1140px', margin: '0 auto', padding: '3rem 1.5rem 6rem 1.5rem' }}>
      ...
      <div style={{ marginBottom: '5rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <h2 style={{ fontSize: '1.8rem', marginBottom: '0.5rem' }}>How PulsePoll Works</h2>
        ...
        <div style={{
          ...
          {[
            ...
            },
            {
              ...
              icon: <QrCode size={22} color="#a855f7" />,
            },
            {
              step: '03',
      ...
      <div className="glass-panel" style={{ padding: '2.5rem', border: '1px solid var(--border-subtle)' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.6rem', marginBottom: '0.4rem' }}>Engineered for True Real-Time Performance</h2>
        ...
        <div style={{
          ...
          <div style={{ padding: '1.25rem', borderRadius: '12px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-subtle)' }}>
            <div style={{ color: '#61dafb', fontWeight: 700, marginBottom: '0.25rem' }}>React Frontend</div>
          ...
          <div style={{ padding: '1.25rem', borderRadius: '12px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-subtle)' }}>
            <div style={{ color: '#00add8', fontWeight: 700, marginBottom: '0.25rem' }}>Go (Gin) Backend</div>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
          ...
          <div style={{ padding: '1.25rem', borderRadius: '12px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-subtle)' }}>
            <div style={{ color: '#ef4444', fontWeight: 700, marginBottom: '0.25rem' }}>Redis Realtime Bus</div>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
              Drives atomic in-memory vote counters (<code style={{ color: '#fca5a5' }}>HINCRBY</code>) and instant event fanout via Redis Pub/Sub.
            </p>
          </div>

          <div style={{ padding: '1.25rem', borderRadius: '12px', background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-subtle)' }}>
            <div style={{ color: '#10b981', fontWeight: 700, marginBottom: '0.25rem' }}>MongoDB Database</div>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
